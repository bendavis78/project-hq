...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.submitted_by'
        db.add_column('tickets_ticket', 'submitted_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='submitted_tickets', to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.submitted_by'
        db.delete_column('tickets_ticket', 'submitted_by_id')
    ...
    models = {
        ...
        'tickets.ticket': {
            ...
            'submitted_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 30, 13, 28, 7, 692946)'}),
            'tags': ('tagging.fields.TagField', [], {}),
