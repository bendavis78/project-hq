...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tickets_ticket', 'priority', self.gf('django.db.models.fields.IntegerField')(default=999999))

        # Adding index on 'Ticket', fields ['priority']
        db.create_index('tickets_ticket', ['priority'])


    def backwards(self, orm):
        
        # Removing index on 'Ticket', fields ['priority']
        db.delete_index('tickets_ticket', ['priority'])

        # Changing field 'Ticket.priority'
        db.alter_column('tickets_ticket', 'priority', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'tickets.ticket': {
            ...
            'submitted_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 1, 10, 52, 18, 279556)'}),
            'tags': ('tagging.fields.TagField', [], {}),
