...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('taskboard_task', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['taskboard.Team']))

        # Changing field 'TeamStrengthAdjustment.team'
        db.alter_column('taskboard_teamstrengthadjustment', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['taskboard.Team']))


    def backwards(self, orm):
        
        # Changing field 'Task.team'
        db.alter_column('taskboard_task', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group']))

        # Changing field 'TeamStrengthAdjustment.team'
        db.alter_column('taskboard_teamstrengthadjustment', 'team_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 17, 19, 22, 7, 635670)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 17, 19, 22, 7, 635606)'}),
        ...
        'history.event': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 17, 19, 22, 7, 639354)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'taskboard.team': {
            ...
            'velocity': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'velocity_strategy': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
        'taskboard.teamstrengthadjustment': {
            ...
            'team': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'strength_adjustments'", 'to': "orm['taskboard.Team']"})
        },
        'tickets.ticket': {
            ...
            'submitted_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 17, 19, 22, 7, 640521)'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
        'tickets.ticketuser': {
