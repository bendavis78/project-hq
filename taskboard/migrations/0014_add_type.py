...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('taskboard_task', 'type', self.gf('django.db.models.fields.CharField')(default='FEATURE', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Task.type'
        db.delete_column('taskboard_task', 'type')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 17, 19, 31, 15, 471043)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 17, 19, 31, 15, 470980)'}),
        ...
        'history.event': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 17, 19, 31, 15, 474605)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tickets.ticket': {
            ...
            'submitted_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 17, 19, 31, 15, 471839)'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
        'tickets.ticketuser': {
