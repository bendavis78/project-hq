...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamStrengthAdjustment.percentage'
        db.alter_column('taskboard_teamstrengthadjustment', 'percentage', self.gf('django.db.models.fields.PositiveIntegerField')())


    def backwards(self, orm):
        
        # Changing field 'TeamStrengthAdjustment.percentage'
        db.alter_column('taskboard_teamstrengthadjustment', 'percentage', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=2))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 5, 20, 18, 52, 629460)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 5, 20, 18, 52, 629400)'}),
        ...
        'history.event': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 5, 20, 18, 52, 628403)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'taskboard.task': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'FEATURE'", 'max_length': '20'})
        },
        'taskboard.taskuser': {
        ...
        'tickets.ticket': {
            ...
            'submitted_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 5, 20, 18, 52, 626385)'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
        'tickets.ticketuser': {
