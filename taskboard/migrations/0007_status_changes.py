...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('taskboard_task', 'completed')

        # Deleting field 'Task.icebox'
        db.delete_column('taskboard_task', 'icebox')

        # Adding field 'Task.started_date'
        db.add_column('taskboard_task', 'started_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Task.finished_date'
        db.add_column('taskboard_task', 'finished_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Task.completed'
        db.add_column('taskboard_task', 'completed', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)
        ...
        # Deleting field 'Task.started_date'
        db.delete_column('taskboard_task', 'started_date')

        # Deleting field 'Task.finished_date'
        db.delete_column('taskboard_task', 'finished_date')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 11, 13, 6, 51, 585381)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 11, 13, 6, 51, 585321)'}),
        ...
        'history.event': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 11, 13, 6, 51, 582950)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'taskboard.task': {
            ...
            'finished_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tickets.ticket': {
            ...
            'submitted_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 11, 13, 6, 51, 581358)'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
        'tickets.ticketuser': {
