...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamStrengthAdjustment.percentage'
        db.add_column('taskboard_teamstrengthadjustment', 'percentage', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=2, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeamStrengthAdjustment.percentage'
        db.delete_column('taskboard_teamstrengthadjustment', 'percentage')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 2, 18, 44, 0, 947521)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 2, 18, 44, 0, 947277)'}),
        ...
        'history.event': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 2, 18, 44, 0, 957002)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'tickets.ticket': {
            ...
            'submitted_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 2, 18, 44, 0, 953170)'}),
            'tags': ('tagging.fields.TagField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '250'})
        },
        'tickets.ticketuser': {
